...
int i = 0;
int distanza=10;  //massima differenza tra un acquisizione e l'altra
int precedente;
...
void setup() {
  ...
  //risoluzione DAC con 1023 posizioni
  ...
  analogWrite(DAC1, map(th1Low + 20, th1Low, th1Up, 0, 1023)); //torque
  ...
  while (analogRead(SC) > SCthr && RTD && plaus1 && plaus2) {
    ...
    */
    ...
    if (plaus1 && plaus2) {
      ...
      analogWrite(DAC1, map(th1, th1Low, th1Up, 0, 1023));
      analogWrite(DAC0, 0);
